  ...
  return (
    <div className="w-screen mt-20">
      <div className="pt-40 pb-20">
        ...
        <h2 className="pt-5 text-center text-black text-3xl lg:text-4xl ">
          LET THE CUSTOMERS <a className="text-orange">STING</a> WITH YOUR
          <br className="max-[300]:visible" />
          WEBSITE
        </h2>
        <h3 className="mt-3 text-center text-gray font-sans text-lg lg:text-xl">
